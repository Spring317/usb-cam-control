...
This section describes the software architecture, USB Picture Transfer Protocol (PTP/ISO 15740) data acquisition pipeline, and system modeling for the Canon EOS R8 FastAPI control system. The full implementation source code is available at \url{https://github.com/Spring317/usb-cam-control}.
